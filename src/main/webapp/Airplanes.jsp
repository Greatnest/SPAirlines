...
<body>
	<div id="wrapper">
		...
		<div id="content">
			<div id="sidebar">
				<br />
				<p class="loginword">Please login to manage your online booking.</p>
				<br />
				<br />
				<form action="getAdminData.jsp" method="post">
					<label>User ID: <input type="text" class="inputLogin"
						name="userid" />
			...
			<div id="maincon">
				...
				<form action="p_flightScheduleResult.jsp" id="form3" method="post">
					...
					<fieldset>
						<label> Flying from: <select name="origin">
						...
						<br /> <label> Flying to: <select name="destination">
						...
						<label> Departure Date: <select name="departureYYYY">
								<option value="null" selected>Year</option>
								<option value="2014">2014</option>
								<option value="2013">2015</option>

						</select> <select name="departureMM">
						...
						</select> <select name="departureDD">
						...
						<br /> <label> Return Date: <select name="returnYYYY">
								<option value="null" selected>Year</option>
								<option value="2014">2014</option>
								<option value="2013">2015</option>

						</select> <select name="returnMM">
								<option value="null" selected>Month</option>
								<option value="1">Jan</option>
								<option value="2">Feb</option>
								<option value="3">Mar</option>
