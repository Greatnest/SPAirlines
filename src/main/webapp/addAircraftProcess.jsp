			...
			<div id="maincon">
				...
				<%
					...
					try {
						...
						String connURL = "jdbc:mysql://" + host + ":" + port
								+ "/spairlines?" + "user=" + dbusername + "&password="
								+ dbpassword;
						...
						if (rec == 1) {
				%>
				<p class="para">New Aircraft details has been added into the
					database and can be viewed under Aircraft Information.</p>
				<%
					} else {
				%>
				<p class="para">Unfortunately, the database is not successfully
					updated. Please check your input.</p>
				<%
					}
						conn.close();
					} catch (Exception e) {
