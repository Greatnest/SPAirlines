...
<body>
	<div id="wrapper">
		...
		<div id="bannerbox">
			<img src="banners-bg/banner.jpg" width="900" height="350"
				alt="Welcome" />
		</div>
		...
		<div id="content">
			<div id="sidebar">
				<br />
				<div class="sidenav1">
					<p class="sidenavTitle1">
						<img class="arrow1" src="icons/arrow-expandedrotated.png"
							alt="arrow" /> Aircraft
					</p>
					<ul class="list1">
						<br />
				...
				<div class="sidenav2">
					<p class="sidenavTitle2">
						<img class="arrow2" src="icons/arrow-expandedrotated.png"
							alt="arrow" /> Flight Schedule
					</p>
					<ul class="list2">
						<br />
				...
				<div class="sidenav3">
					<p class="sidenavTitle3">
						<img class="arrow3" src="icons/arrow-expandedrotated.png"
							alt="arrow" /> Admin
					</p>
					<ul class="list3">
						<br />
			...
			<div id="maincon">
				...
				<form action=updateFlight.jsp id="form2" method="post">
					...
					<fieldset>
						...
						<br /> <label>FSID: <input type="text" name="ID"
							value="<%=fsid%>">
						</label><br />
						<br /> <label>Aircraft ID: <input type="text"
							name="craftID" value="<%=aircraftID%>">
						</label><br />
						<br /> <label>Origin Airport: <input type="text"
							name="origin" value="<%=origin%>">
						</label><br /></br> <label>Destination Airport: <input type="text"
							name="destination" value="<%=destination%>">
						</label><br />
						<br /> <label>Country: <input type="text" name="country"
							value="<%=country%>">
						</label><br />
						<br /> <label>Origin Country: <input type="text"
							name="origincountry" value="<%=originCountry%>">
						</label><br />
						<br /> <label>Flight Duration: <input type="text"
							name="duration" value="<%=duration%>">
						</label><br />
						<br /> <label>Departure Date: <input type="text"
							name="dateDepart" value="<%=dateDepart%>">
						</label><br />
						<br /> <label>Departing: <input type="text"
							name="departTime" value="<%=departTime%>">
						</label><br />
						<br /> <label>Arrival Date: <input type="text"
							name="dateArrive" value="<%=dateArrive%>">
						</label><br />
						<br /> <label>Arriving: <input type="text"
							name="arriveTime" value="<%=arriveTime%>">
						</label><br />
						<br /> <label>Interconnect ID (if any): <input type="text"
							name="interconnect" value="<%=interconnect%>">
						</label><br />
						<br /> <label>Overlay Time (if any): <input type="text"
							name="overlay" value="<%=layover%>">
						</label><br />
						<br />
						<br />
					...
					<fieldset>
						...
						<br /> <label>Economy Class: <input type="text"
							name="economy" value="<%=economy%>">
						</label><br />
						<br /> <label>Business Class: <input type="text"
							name="business" value="<%=business%>">
						</label><br />
						<br /> <label>First Class: <input type="text" name="first"
							value="<%=first%>">
						</label><br />
						<br />
					</fieldset>
				...
				%>
				<p class="para">Selected flight record(s) have been successfully
					deleted.</p>
				<%
					conn.close();
